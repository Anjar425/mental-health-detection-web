  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans">
      ...
      <main className="flex-1 container mx-auto px-3 sm:px-4 md:px-6 py-4 sm:py-6 space-y-6 sm:space-y-8">
        ...
        {/* Stats Section */}
        <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 animate-in slide-in-from-bottom-4 duration-500">
          <StatsCard 
            title="Total Users" 
        ...
        <section className="space-y-4 animate-in slide-in-from-bottom-6 duration-700 delay-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            ...
            <Link 
              href="/admin/groups" 
              className="p-4 sm:p-6 border border-border bg-card rounded-xl hover:bg-accent/50 hover:border-primary/30 transition-all duration-200 shadow-sm group"
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-semibold text-card-foreground group-hover:text-primary transition-colors text-sm sm:text-base">Manage Groups</h3>
              </div>
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-semibold text-card-foreground group-hover:text-primary transition-colors text-sm sm:text-base">Manage Users</h3>
              </div>
              <p className="text-xs sm:text-sm text-muted-foreground">
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-semibold text-card-foreground group-hover:text-primary transition-colors text-sm sm:text-base">Manage Experts</h3>
              </div>
              <p className="text-xs sm:text-sm text-muted-foreground">
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-semibold text-card-foreground group-hover:text-primary transition-colors text-sm sm:text-base">Expert Rankings</h3>
              </div>
              <p className="text-xs sm:text-sm text-muted-foreground">
